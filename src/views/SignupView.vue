    ...
    <div  class="max-w-7xl mx-auto grid grid-cols-2 gap-4">
        <div class="main-left">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                ...
                <p class="font-bold">
                    Already have an account?<router-link to="/login" class="underline">Click here</router-link>to login !
                    </p>
            </div>
        </div>
        ...
        <div class="main-right">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <form class="space-y-6" v-on:submit.prevent="submitForm">
                    ...
                    <div>
                        <button class="py-4 px-6 bg-purple-600 text-white rounded-lg"><router-link to="/">sign up</router-link></button>
                    </div>
                </form>
            </div>
        </div>
